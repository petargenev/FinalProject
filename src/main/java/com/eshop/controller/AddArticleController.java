...
public class AddArticleController {
	...
	public String addNewComputer(@RequestParam("file") MultipartFile multipartFile,
			@Valid @ModelAttribute Computer computer, BindingResult result, Model model)
	...
	public String addNewTablet(@RequestParam("file") MultipartFile multipartFile, @ModelAttribute Tablet tablet,
			Model model) throws UserException, ArticleException, IOException, InvalidInputException {
	...
	public String addNewLaptop(@RequestParam("file") MultipartFile multipartFile, @ModelAttribute Laptop laptop,
			Model model) throws UserException, ArticleException, InvalidInputException, IOException {
